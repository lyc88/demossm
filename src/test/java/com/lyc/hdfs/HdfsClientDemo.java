...
public class HdfsClientDemo {
    ...
    public void init() throws Exception{
        ...
        conf.set("fs.defaultFS", "hdfs://192.168.6.101:9000");
        System.setProperty("hadoop.home.dir", "C:\\hadoop-2.6.1");
        //拿到一个文件系统操作的客户端实例对象
		/*fs = FileSystem.get(conf);*/
        //可以直接传入 uri和用户身份
        fs = FileSystem.get(new URI("hdfs://192.168.6.101:9000"),conf,"root"); //最后一个参数为用户名
    }
    ...
    public void testUpload() throws Exception {
        ...
        Thread.sleep(2000);
        fs.copyFromLocalFile(new Path("e:/example.png"), new Path("/access.log1.copy"));
        fs.close();
    }
